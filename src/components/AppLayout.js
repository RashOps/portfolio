		...
		<>
			...
			<header className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-6 py-4 bg-surface/80 backdrop-blur-xl border-b border-white/5">
				...
				<div className="flex items-center gap-2">
					<button
						onClick={() => showToast("✨ Aucune notification pour le moment")}
						className="text-on-surface-variant hover:text-primary p-2 rounded-lg hover:bg-white/5 transition-all duration-150 active:scale-95"
					>
			...
			<aside className="fixed left-0 top-0 h-screen w-64 z-40 flex-col bg-surface-container-low/50 backdrop-blur-xl border-r border-white/5 pt-20 hidden md:flex">
				...
				<nav className="flex-grow flex flex-col gap-1 font-body text-sm overflow-y-auto">
					...
					<a
						href="https://www.linkedin.com/in/rayhan-touboui-machine-learning-powerbi-nlp-data-science"
						target="_blank"
						rel="noopener noreferrer"
						className="flex items-center gap-3 text-on-surface-variant mx-3 px-4 py-2.5 rounded-lg hover:bg-white/5 hover:text-on-surface transition-all duration-200"
					>
				...
				<div className="px-6 mb-6">
					<button
						onClick={toggleConsole}
						className="w-full bg-gradient-to-r from-primary to-tertiary text-white font-headline font-bold text-xs py-3 rounded-lg tracking-wide hover:shadow-lg hover:shadow-primary/20 transition-all active:scale-95"
					>
				...
				<div className="mt-auto border-t border-white/5 py-3 flex flex-col gap-1 font-body text-sm">
					<button
						onClick={() =>
							showToast("🔒 Accès restreint — Droits administrateur requis")
						}
						className="flex items-center gap-3 text-on-surface-variant mx-3 px-4 py-2.5 rounded-lg hover:bg-white/5 hover:text-on-surface w-full text-left transition-all duration-200"
					>
					...
					<button
						onClick={() =>
							showToast("👋 Session active — Déconnexion impossible")
						}
						className="flex items-center gap-3 text-on-surface-variant mx-3 px-4 py-2.5 rounded-lg hover:bg-white/5 hover:text-on-surface w-full text-left transition-all duration-200"
					>
					...
					<>
						...
						>
							<nav className="flex-grow flex flex-col gap-1 font-body text-base overflow-y-auto">
								...
								<a
									href="https://www.linkedin.com/in/rayhan-seh-fred-touboui"
									target="_blank"
									rel="noopener noreferrer"
									className="flex items-center gap-4 text-on-surface-variant mx-4 px-5 py-3.5 rounded-lg"
								>
							...
							<div className="p-6 border-t border-white/5">
								<button
									onClick={toggleConsole}
									className="w-full bg-gradient-to-r from-primary to-tertiary text-white font-headline font-bold text-sm py-4 rounded-xl tracking-wide"
								>
									✦ Assistant Atlas
								</button>
							</div>
				...
				<footer className="py-12 px-6 border-t border-white/5 mt-24">
					<div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
						<div className="flex items-center gap-6">
							<span className="font-headline font-bold text-lg gradient-text">
								Rayhan.
							</span>
						...
						<div className="flex items-center gap-6">
							...
							<a
								href="mailto:touboui.sehfredrayhan@gmail.com"
								className="text-on-surface-variant hover:text-primary transition-colors"
							>
