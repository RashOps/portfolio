...
export default function SkillTree() {
	...
	const bars = Array.from(
		{ length: 10 },
		(_, i) => i < Math.round(versatilityIndex / 10),
	);
				...
				<FadeIn direction="down" className="mb-10 md:mb-16">
					...
					<div className="flex items-center gap-4 mt-3">
						...
						<p className="font-body text-xs md:text-sm text-on-surface-variant">
							Mon arsenal technique pour transformer la donnée
						</p>
					</div>
				</FadeIn>
				...
				<StaggerContainer className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 mb-20">
					...
					<StaggerItem className="lg:col-span-8 glass rounded-2xl p-6 sm:p-8 relative overflow-hidden">
						...
						<div className="space-y-8">
							<FadeIn delay={0.2} direction="left">
								<div className="flex justify-between items-end mb-3">
									<span className="font-body text-sm text-on-surface">
										NLP &amp; Traitement du langage (BERT, FastText, Sentiment
										Analysis)
									</span>
									<span className="font-headline text-sm text-primary font-medium">
										Intermédiaire +
									</span>
								</div>
								<div className="h-2 bg-white/5 rounded-full overflow-hidden">
									<div
										className="bg-gradient-to-r from-primary to-primary-dim h-full rounded-full transition-all duration-1000 ease-out"
										style={{ width: "78%" }}
									></div>
								</div>
							</FadeIn>
							<FadeIn delay={0.3} direction="left">
								<div className="flex justify-between items-end mb-3">
									<span className="font-body text-sm text-on-surface">
										Machine Learning (Clustering K-Means, Scikit-Learn)
									</span>
									<span className="font-headline text-sm text-on-surface-variant font-medium">
										Avancé
									</span>
								</div>
								<div className="h-2 bg-white/5 rounded-full overflow-hidden">
									<div
										className="bg-gradient-to-r from-primary/80 to-primary-dim/80 h-full rounded-full transition-all duration-1000 ease-out"
										style={{ width: "78%" }}
									></div>
								</div>
							</FadeIn>
							<FadeIn delay={0.4} direction="left">
								<div className="flex justify-between items-end mb-3">
									<span className="font-body text-sm text-on-surface">
										Data Cleaning &amp; Statistiques descriptives (Pandas,
										NumPy)
									</span>
									<span className="font-headline text-sm text-on-surface-variant font-medium">
										Avancé
								...
								<div className="h-2 bg-white/5 rounded-full overflow-hidden">
									<div
										className="bg-gradient-to-r from-primary/60 to-primary-dim/60 h-full rounded-full transition-all duration-1000 ease-out"
										style={{ width: "81%" }}
									></div>
								</div>
							</FadeIn>
					...
					<div className="lg:col-span-4 space-y-8">
						<StaggerItem className="glass rounded-2xl p-6">
							<h3 className="font-headline text-sm text-secondary mb-4 font-medium">
								Indice de polyvalence
							</h3>
							<div className="flex items-end gap-2 mb-3">
								<span className="text-4xl font-headline font-bold gradient-text">
									{versatilityIndex}
								</span>
								<span className="text-sm font-body text-on-surface-variant mb-1">
									/ 100
								</span>
							</div>
					...
					<StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-4">
						<StaggerItem className="glass rounded-2xl p-8 card-hover group">
							...
							<p className="text-sm text-on-surface-variant font-body leading-relaxed mb-6">
								Harmonisation de datasets hétérogènes (multi-sources) et
						...
						<StaggerItem className="glass rounded-2xl p-8 card-hover group">
							...
							<p className="text-sm text-on-surface-variant font-body leading-relaxed mb-6">
								Modélisation relationnelle (PostgreSQL, MySQL) et
								non-relationnelle (MongoDB). Triggers & Listen/Notify.
							</p>
							<div className="flex gap-1 h-1.5 rounded-full overflow-hidden">
						...
						<StaggerItem className="glass rounded-2xl p-8 card-hover group">
							...
							<p className="text-sm text-on-surface-variant font-body leading-relaxed mb-6">
								Déploiement de workflows automatisés pour la surveillance temps
								réel des bases critiques.
							</p>
							<div className="flex gap-1 h-1.5 rounded-full overflow-hidden">
								...
								<div className="flex items-center gap-4">
									...
									<div>
										...
										<p className="text-xs font-body text-on-surface-variant">
											Applications Data interactives
										</p>
									</div>
								</div>
								<span className="material-symbols-outlined text-green-400/50">
									check_circle
								</span>
							</div>
							...
							<div className="glass rounded-xl p-5 flex items-center justify-between group card-hover">
								<div className="flex items-center gap-4">
									...
									<div>
										...
										<p className="text-xs font-body text-on-surface-variant">
											Design UI & Modélisation Système
										</p>
									</div>
								</div>
								<span className="material-symbols-outlined text-green-400/50">
						...
						<div className="glass rounded-2xl p-8">
							<div className="space-y-8">
								...
								<FadeIn delay={0.2} direction="up">
									...
									<div className="h-3 bg-white/5 rounded-full overflow-hidden">
										<div
											className="h-full bg-gradient-to-r from-secondary to-secondary-dim rounded-full transition-all duration-1000"
											style={{ width: "82%" }}
										></div>
									</div>
								</FadeIn>
								...
								<FadeIn delay={0.3} direction="up">
									...
									<div className="h-3 bg-white/5 rounded-full overflow-hidden">
										<div
											className="h-full bg-gradient-to-r from-tertiary to-tertiary-dim rounded-full transition-all duration-1000"
											style={{ width: "80%" }}
										></div>
									</div>
								</FadeIn>
