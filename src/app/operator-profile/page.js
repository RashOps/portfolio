	...
	return (
		<main className="p-6 md:p-10 lg:p-12 relative overflow-hidden">
			...
			<div className="max-w-7xl mx-auto relative z-10">
				...
				<StaggerContainer className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
					...
					<div className="md:col-span-12 lg:col-span-4 space-y-8">
						...
						<StaggerItem className="glass rounded-2xl p-6 space-y-4">
							<h2 className="font-headline text-xs tracking-widest text-secondary uppercase">
								Identité
							</h2>
							<div className="grid grid-cols-2 gap-4">
								<div>
									<div className="text-xs font-body text-on-surface-variant mb-1">
										Nom
									</div>
					...
					<div className="md:col-span-12 lg:col-span-8 space-y-8">
							...
							<div className="space-y-6">
								<div className="space-y-2">
									...
									<div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
										<div
											className="h-full bg-gradient-to-r from-primary to-primary-dim rounded-full transition-all duration-1000 ease-out"
											style={{ width: "82%" }}
										></div>
									</div>
								</div>
								...
								<div className="space-y-2">
									<div className="flex justify-between items-end">
										...
										<span className="font-headline text-secondary text-sm">
											80%
										</span>
									</div>
									<div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
										<div
											className="h-full bg-gradient-to-r from-secondary to-secondary-dim rounded-full transition-all duration-1000 ease-out"
											style={{ width: "80%" }}
										></div>
									</div>
								</div>
								...
								<div className="space-y-2">
									<div className="flex justify-between items-end">
										...
										<span className="font-headline text-tertiary text-sm">
											85%
										</span>
									</div>
									<div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
										<div
											className="h-full bg-gradient-to-r from-tertiary to-tertiary-dim rounded-full transition-all duration-1000 ease-out"
											style={{ width: "85%" }}
										></div>
									</div>
								</div>
								...
								<div className="space-y-2">
									<div className="flex justify-between items-end">
										<span className="font-body text-sm">
											Vision Stratégique & ROI (Excelia School)
										</span>
										<span className="font-headline text-primary text-sm">
											95%
										</span>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
							<StaggerItem className="glass rounded-2xl p-6 space-y-4">
								...
								<p className="text-on-surface-variant text-sm leading-relaxed font-body text-balance">
									Hybridé par deux années de Bachelor Business à Excelia, mon
									parcours a pris un tournant décisif en Septembre 2025 avec
									l'intégration du Double Diplôme en Intelligence Artificielle
									(PSTB). Cette dualité me permet de concevoir des solutions IA
									qui ne sont pas seulement techniquement robustes, mais
									réellement alignées sur les impératifs de ROI et de
									performance métier.
								</p>
							</StaggerItem>
							...
							<StaggerItem className="glass rounded-2xl p-6 space-y-4">
								...
								<ul className="space-y-2">
									<li className="flex items-center gap-2 text-sm text-on-surface">
										<span className="text-secondary">→</span> Concevoir des
										pipelines (Engineering)
									</li>
									<li className="flex items-center gap-2 text-sm text-on-surface">
										<span className="text-secondary">→</span> Modéliser
										l'insight (Science & Analyse)
									</li>
									<li className="flex items-center gap-2 text-sm text-on-surface">
										<span className="text-secondary">→</span> Transformer les
										données en actifs stratégiques
									</li>
								</ul>
							</StaggerItem>
						</div>
						...
						<StaggerItem className="pt-4">
							<Link
								className="block group w-full relative overflow-hidden rounded-xl"
								href="/mission-log"
							>
								<div className="bg-gradient-to-r from-primary to-tertiary px-8 py-5 flex items-center justify-between rounded-xl group-active:scale-[0.98] transition-all">
									<span className="font-headline text-white font-bold tracking-wide text-lg">
										Voir mes projets (Missions)
									</span>
									<div className="flex items-center gap-4">
				...
				<FadeIn
					direction="up"
					className="max-w-6xl mx-auto mt-12 border-t border-white/5 pt-4 flex justify-between items-center text-on-surface-variant/40"
				>
					<div className="font-body text-xs hidden sm:block">
						Mis à jour en 2026
					</div>
					<div className="font-body text-xs">
						Portfolio conçu avec Next.js &amp; Tailwind
					</div>
					<div className="flex items-center gap-2">
						<div className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></div>
						<div className="font-body text-xs text-balance">
							Connectivité Atlas Bot : OK
						</div>
					</div>
				</FadeIn>
			</div>
