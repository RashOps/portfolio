	...
	return (
		<>
				...
				<div className="relative z-10 max-w-5xl w-full text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-16 pt-20 md:pt-0">
					<div className="flex-1">
						...
						>
							...
							<span className="font-body text-xs text-on-surface-variant uppercase font-bold tracking-tighter">
								Disponible pour Stage & Alternance (24 mois)
							</span>
						</FadeIn>
						...
						<FadeIn delay={0.3} direction="up">
							<p className="font-body text-on-surface-variant text-lg max-w-xl mb-10 leading-relaxed">
								Moi c'est <span className="text-primary font-bold">Rayhan</span>
								. Après deux ans de{" "}
								<span className="text-on-surface font-bold">
									Bachelor Business @Excelia
								</span>
								, j'ai pivoté en Septembre 2025 vers la{" "}
								<span className="text-on-surface font-bold">Data & l'IA</span>.
								Je fusionne aujourd'hui vision stratégique et ingénierie pour
						...
						>
							<TrackedInternalLink
								href="/mission-log"
								eventName="view_missions_cta"
								className="bg-gradient-to-r from-primary to-tertiary text-white font-headline font-bold px-8 py-4 rounded-xl text-sm flex items-center justify-center gap-3 hover:shadow-lg hover:shadow-primary/25 transition-all active:scale-95 group"
							>
								Voir mes missions
			...
			<section className="py-24 px-6 max-w-7xl mx-auto">
				...
				>
					<div>
						<h3 className="font-headline text-4xl font-bold mb-2 tracking-tight">
							Missions Phares
						</h3>
						<p className="font-body text-sm text-on-surface-variant">
							Une sélection de mes réalisations les plus techniques
						</p>
					</div>
					<Link
						href="/mission-log"
						className="font-body text-sm text-primary hover:underline flex items-center gap-2 font-bold uppercase tracking-widest text-[10px]"
					>
						Toutes les missions{" "}
				...
				<StaggerContainer className="grid grid-cols-1 md:grid-cols-12 gap-6">
					...
					<StaggerItem className="md:col-span-7 relative">
						<TrackedInternalLink
							href="/decrypt-demos/marketpulse-ai"
							eventName="project_view"
							eventData={{ project: "marketpulse" }}
							className="h-full w-full glass rounded-2xl relative overflow-hidden group card-hover block"
						>
							<Image
								fill
							...
							<div className="relative z-10 h-full p-8 flex flex-col justify-end">
								<span className="font-label text-xs text-secondary mb-2 tracking-wide uppercase font-bold">
									Machine Learning Engine
								</span>
								<h4 className="font-headline text-3xl font-bold text-on-surface mb-4">
									MarketPulse AI
								</h4>
								<p className="font-body text-sm text-on-surface-variant max-w-md mb-6 leading-relaxed">
									Moteur de segmentation temps réel (PCA / K-Means) pour la
									détection de régimes de marché financier via API FastAPI.
								</p>
								<div className="flex gap-3">
									<span className="px-3 py-1 glass rounded-lg text-[10px] text-primary font-bold uppercase tracking-wider">
										FastAPI
									</span>
									<span className="px-3 py-1 glass rounded-lg text-[10px] text-primary font-bold uppercase tracking-wider">
										Scikit-Learn
					...
					<div className="md:col-span-5 grid grid-cols-1 grid-rows-none md:grid-rows-3 gap-6">
						...
						<StaggerItem className="relative h-full">
							<Link
								href="/decrypt-demos/finsight-rag"
								className="h-full glass rounded-2xl p-6 min-h-[180px] relative overflow-hidden card-hover flex flex-col justify-center block group"
							>
								<Image
									fill
								...
								<div className="absolute top-4 right-4 z-10">
									<span className="material-symbols-outlined text-green-400/50 text-4xl group-hover:text-green-400 transition-colors">
										hub
									</span>
								</div>
								<div className="relative z-10">
									<span className="font-label text-xs text-green-400 mb-2 tracking-wide uppercase font-bold">
										Generative AI
									</span>
									...
									<p className="font-body text-xs text-on-surface-variant line-clamp-2">
										Moteur de recherche sémantique financier (FastAPI,
										LlamaIndex, Qdrant).
									</p>
								</div>
							</Link>
						...
						<StaggerItem className="relative h-full">
							...
							>
								...
								/>
								<div className="absolute top-4 right-4 z-10">
									<span className="material-symbols-outlined text-primary/20 text-4xl group-hover:text-primary/40 transition-colors">
										analytics
									</span>
								</div>
								<div className="relative z-10">
									...
									<p className="font-body text-xs text-on-surface-variant line-clamp-2">
										Analyse de sentiment et topic modeling sur 23k+ avis clients
										via Python et Dash.
									</p>
								</div>
							</Link>
						...
						<StaggerItem className="relative h-full">
							<Link
								href="/mission-log"
								className="h-full glass rounded-2xl min-h-[180px] relative overflow-hidden card-hover group block"
							>
								<Image
									fill
								...
								<div className="relative z-10 p-6 flex flex-col justify-end h-full">
									<span className="font-label text-xs text-tertiary mb-2 tracking-wide uppercase font-bold">
										Fullstack JS
									</span>
									...
									<p className="text-[10px] text-on-surface-variant font-body mt-2">
										Architecture React / Express avec Glassmorphism UI.
									</p>
								</div>
							</Link>
						</StaggerItem>
			...
			<section className="py-24 px-6 bg-surface-container-low/50">
				<div className="max-w-7xl mx-auto">
					<FadeIn direction="up" className="text-center mb-20">
						<h3 className="font-headline text-4xl font-bold tracking-tight mb-4 text-on-surface">
							Fondation Business,{" "}
							<span className="gradient-text">Moteurs Data</span>
						</h3>
						<p className="font-body text-on-surface-variant max-w-2xl mx-auto">
							Un profil hybride capable de traduire des besoins métiers
							complexes en architectures IA performantes.
						</p>
					</FadeIn>
					...
					<StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
						...
						<StaggerItem className="space-y-4">
							...
							<div className="h-2 bg-white/5 rounded-full overflow-hidden">
								<div
									className="h-full bg-gradient-to-r from-secondary to-secondary-dim rounded-full"
									style={{ width: "72%" }}
								></div>
							</div>
							<p className="font-body text-xs text-on-surface-variant">
						...
						<StaggerItem className="space-y-4">
							...
							<div className="h-2 bg-white/5 rounded-full overflow-hidden">
								<div
									className="h-full bg-gradient-to-r from-tertiary to-tertiary-dim rounded-full"
									style={{ width: "69%" }}
								></div>
							</div>
							<p className="font-body text-xs text-on-surface-variant">
						...
						<div className="md:col-span-3 mt-8">
							...
							>
								{[
									...
									>
										<p className="font-body text-[10px] text-on-surface-variant group-hover:text-primary mb-1 transition-colors uppercase font-bold tracking-widest">
											{skill.name}
										</p>
