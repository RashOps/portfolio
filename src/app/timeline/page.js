			...
			<div className="px-6 py-10 md:p-10 relative">
				...
				>
					<div className="flex items-center gap-4 mb-2">
						<span className="font-body text-xs md:text-sm text-on-surface-variant whitespace-nowrap">
				...
				<div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
					...
					<div className="relative pl-12" id="academic-path">
						...
						>
							...
							<h2 className="font-headline text-lg text-on-surface font-bold">
						...
						<div className="space-y-12">
							...
							<FadeIn delay={0.1} direction="right" className="relative">
								...
								<div className="glass rounded-2xl p-6 card-hover">
									<div className="font-body text-xs text-secondary mb-2">
										2026 — 2028 (Admis)
									</div>
									<h4 className="font-headline text-lg text-on-surface mb-1 font-bold">
									...
									<div className="flex gap-2 flex-wrap">
										<span className="px-2 py-1 glass rounded-lg text-xs text-primary">
											Master Spécialisé
										</span>
										<span className="px-2 py-1 glass rounded-lg text-xs text-primary">
											IA Architecture
							...
							<FadeIn delay={0.2} direction="right" className="relative">
								...
								<div className="glass rounded-2xl p-6 card-hover border border-primary/20 bg-primary/5">
									...
									<h4 className="font-headline text-lg text-on-surface mb-1 font-bold italic">
										Double Diplôme & Pivot IA
									</h4>
									<div className="text-sm font-body text-on-surface-variant mb-3">
									...
									<p className="text-[11px] text-on-surface-variant font-body mb-3 leading-relaxed">
										Année de transformation : Immersion intensive en
										programmation, outils ML et architectures data suite à un
										cursus business.
									</p>
									<div className="flex gap-2 flex-wrap">
										<span className="px-2 py-1 glass rounded-lg text-xs text-primary">
										...
										<span className="px-2 py-1 glass rounded-lg text-xs text-secondary">
											Business Bridge
										</span>
									</div>
								</div>
							...
							<FadeIn delay={0.3} direction="right" className="relative">
								...
								<div className="glass rounded-2xl p-6 opacity-80 border-l border-white/5">
									...
									<div className="text-sm font-body text-on-surface-variant mb-2">
										Excelia Business School — La Rochelle
									</div>
									<p className="text-[11px] text-on-surface-variant/60 font-body">
										Focus : Strategie, Marketing & Analyse ROI. Développement
										d'une vision métier solide indispensable à l'IA appliquée.
									</p>
								</div>
							</FadeIn>
						</div>
						...
						<div className="space-y-12">
							...
							<FadeIn delay={0.1} direction="left" className="relative">
								...
								<div className="glass rounded-2xl p-6 card-hover">
									...
									<div className="text-sm font-body text-on-surface-variant font-medium">
										AESIO (Association étudiante)
									</div>
									<p className="text-on-surface-variant text-xs mt-3 leading-relaxed font-body">
										Leadership & Gouvernance numérique. Standardisation des
										processus de production et Knowledge Management via Google
										Cloud Drive.
									</p>
								</div>
							</FadeIn>
							...
							<FadeIn delay={0.2} direction="left" className="relative">
								...
								<div className="glass rounded-2xl p-6 card-hover">
									...
									<h4 className="font-headline text-lg text-on-surface mb-1 font-bold">
										Chargé de Communication & Analyse Data
									</h4>
									<div className="text-sm font-body text-on-surface-variant font-medium">
										BDE PSTB — Paris
									</div>
									<p className="text-on-surface-variant text-xs mt-3 leading-relaxed font-body">
										Analyse de l'engagement Social Media et segmentation des
										canaux de diffusion. Gestion de projet événementiel (20+
										événements).
									</p>
								</div>
							</FadeIn>
							...
							<FadeIn delay={0.3} direction="left" className="relative">
								...
								<div className="glass rounded-2xl p-6 card-hover">
									...
									<h4 className="font-headline text-lg text-on-surface mb-1 font-bold">
										Stage Assistant Ingénieur Data
									</h4>
									<div className="text-sm font-body text-on-surface-variant font-medium">
										Orange Côte d'Ivoire — Abidjan
									</div>
									<p className="text-on-surface-variant text-xs mt-3 leading-relaxed font-body">
										Déploiement de workflows automatisés (DataOps) avec n8n pour
										la surveillance temps réel de bases PostgreSQL.
									</p>
								</div>
							</FadeIn>
							...
							<FadeIn delay={0.4} direction="left" className="relative">
								...
								<div className="glass rounded-2xl p-6 card-hover">
									...
									<h4 className="font-headline text-lg text-on-surface mb-1 font-bold">
										Stage Analyste des Stocks
									</h4>
									<div className="text-sm font-body text-on-surface-variant font-medium">
										Emmaüs Krefeld — Allemagne
									</div>
									<p className="text-on-surface-variant text-xs mt-3 leading-relaxed font-body">
										Supply Chain & Merchandising Data-Driven. Analyse des flux
										et clustering des comportements clients.
									</p>
								</div>
							</FadeIn>
						</div>
				...
				<StaggerContainer className="mt-20 md:mt-24 grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
					<StaggerItem className="glass rounded-2xl p-6">
						...
						<div className="text-xl md:text-2xl font-headline font-bold gradient-text">
							PSTB &amp; Excelia
						</div>
					...
					<StaggerItem className="glass rounded-2xl p-6">
						...
						<div className="text-xl md:text-2xl font-headline font-bold text-secondary">
							4 Missions
						</div>
						<div className="text-xs font-body text-on-surface-variant mt-2">
							Data, Comm & Supply Chain
						</div>
					</StaggerItem>
					...
					<StaggerItem className="glass rounded-2xl p-6">
						...
						<div className="text-xl md:text-2xl font-headline font-bold text-green-400">
							International
						</div>
						<div className="flex items-center gap-2 mt-2">
							<span className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
							<span className="text-xs font-body text-on-surface-variant">
								Disponible Alternance 24m
							</span>
						</div>
					</StaggerItem>
				</StaggerContainer>
